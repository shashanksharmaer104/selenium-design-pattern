...
public class MainPage {
    ...
    public MainPage(final WebDriver driver) {
        ...
        this.frameA = PageFactory.initElements(this.driver, FrameA.class);
        this.frameB = PageFactory.initElements(this.driver, FrameB.class);
        this.frameC = PageFactory.initElements(this.driver, FrameC.class);
    }
